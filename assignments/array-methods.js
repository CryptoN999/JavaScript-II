...
// Problem 1
//runners.map(runners.filter(runner => runner.first_name.startsWith('B')));
//console.log(runners);
// Problem 2
runners.filter(runner => {if (runner.Gabtype === 5) {Gabtype.push(runner)}});
// Problem 3
runners.map(runner => allCaps.push(runner.last_name.toUpperCase()));
console.log(allCaps);